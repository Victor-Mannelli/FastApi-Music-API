...
def create_playlist(
    ...
    return playlist_services.create_playlist(
...
def add_music_to_playlist(
    ...
    playlist = playlist_services.get_playlist_by_id(db=db, playlist_id=playlist_id)
    ...
    return playlist_services.add_music_to_playlist(
...
def get_user_playlists(user_id: int, db: Session = Depends(get_db)):
    return playlist_services.get_user_playlists(db=db, user_id=user_id)
...
def get_playlist_musics(playlist_id: int, db: Session = Depends(get_db)):
    return playlist_services.get_playlist_musics(db=db, playlist_id=playlist_id)
...
def remove_music_from_playlist(
    ...
    return playlist_services.remove_music_from_playlist(
        db=db, music_id=music_id, playlist_id=playlist_id
    )
...
def update_playlist(
    ...
    return playlist_services.update_playlist(
...
def delete_playlist(
    ...
    return playlist_services.delete_playlist(db=db, playlist_id=playlist_id)
